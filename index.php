...
<?php
$sql = $conn->query("SELECT COUNT(*) FROM user_data");
$row = $sql->fetch_row();
$count = $row[0];
...
?>
          ...
          <div class="row">
            ...
            <a href="list_of_employee.php">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">No. of Employees</div>
