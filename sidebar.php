...
session_start();
if(count($_SESSION) > 0) {
if(!isset($_SESSION['logged_inadmin'])){ //if login in session is not set
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="list_of_employee.php">Employees List</a>
          </div>
        </div>
     ...
     <!-- Divider -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="list_of_customer.php">Customer List</a>
            </div>
        </div>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="material_details.php">Search Materials</a>
            </div>
        </div>
